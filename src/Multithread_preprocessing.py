...
change_cwd()
dataset_to_preprocess = "MIRIAD"
MNI_template, pathlist, finished_pathlist, finished_pp, undone_paths, logger = main_preprocessing(dataset_to_preprocess,search_string="*T1w*.nii.gz")
