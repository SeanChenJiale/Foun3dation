...
OASIS3 = glob.glob('../Dataset/OASIS3/OASIS3_2/**/*.nii.gz', recursive=True) 
print(len(OASIS3))
...
#     fixed_image = sitk.ReadImage("./Dataset/MNI/MNI152_T1_1mm.nii.gz")  # MNI template
    ...
    sitk.WriteImage(moving_resampled,  "../temp/OASIS3_2input_KNN/" + name.split('/')[-1])
    sitk.WriteTransform(final_transform, "../temp/OASIS3_2mask_KNN/" + os.path.splitext(name.split('/')[-1])[0] + ".tfm")
