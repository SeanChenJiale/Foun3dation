...
pathlist = retrieve_nii_gz_paths('../Dataset/OASIS3/**/*T1w.nii.gz')

finished_pathlist = retrieve_nii_gz_paths('../temp/OASIS3_T1_Divy/*.nii.gz')
...
logger = setup_logger("../logs/Oasis3preprocess.log")
...
for filepath in undone_paths:
    ...
    try:
        ...
        sitk.WriteImage(img,f"../temp/OASIS3_T1_Divy/{filename_to_save}")
        logger.info(f"../temp/OASIS3_T1_Divy/{filename_to_save} was saved.")

    except:

        logger.error(f"../temp/OASIS3_T1_Divy/{filename_to_save} had an error.")
